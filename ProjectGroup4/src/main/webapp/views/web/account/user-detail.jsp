								...
								style="display: none; cursor: pointer;"> <a>
									<div class="profilepic">
										...
										<img class="profilepic__image" src="${imgUrl}"
											<c:if test="${account.roleid==3}"> onerror="this.src='${pageContext.request.contextPath}/assets/img/avatar/student.jpg';this.onerror='';" </c:if>										
											<c:if test="${account.roleid==1 || account.roleid==2}"> onerror="this.src='${pageContext.request.contextPath}/assets/img/avatar/lecturer.jpg';this.onerror='';" </c:if>										
										
											width="100" height="100" alt="Profibild"
											style="align-items: center;">
										<div class="profilepic__content">
											<span class="profilepic__icon"><i
												class=""></i></span> <span class="profilepic__text"></span>
										</div>
									</div>
							</a>
							</label>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label>Họ và tên</label> <input type="text"
											class="form-control border-input" disabled placeholder="Nguyễn Văn A"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Địa chỉ Email</label> <input
											type="email" class="form-control border-input" disabled
