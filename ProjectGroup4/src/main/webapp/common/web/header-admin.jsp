...
-->
		...
		<div class="sidebar-wrapper">
			...
			<div class="logo">
				<a href="https://github.com/trankhanh040147/CNPMGroup4" class="simple-text">Admin</a>
			</div>
			<ul class="nav">
				...
				<li><a href="<c:url value="/regPeriod"/>">
						<i class="ti-time"></i>
						<p>Quản lý đợt đăng ký</p>
				</a></li>
...
<!-- 								<img src="" class="rounded-circle" style="width: 150px;" />
 -->
								<div class="card-user">
									...
									src="${imgUrl}"
										onerror="this.src='${pageContext.request.contextPath}/assets/img/avatar/admin.jpg';this.onerror='';"
